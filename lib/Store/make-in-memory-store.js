...
export const makeInMemoryStore = (config = {}) => {
    ...
    const KeyedDB = keyedDB?.default ?? keyedDB; // Reviza@Note 03-02-26 --- Handle CJS ↔ ESM default export differences ⊂⁠(⁠･⁠ω⁠･⁠*⁠⊂⁠)
    ...
    /**
     * binds to a Reviza BaileysEventEmitter.
